...
@property (nonatomic, readonly) id<UITableViewDragLoadDelegate> dragDelegateCC;
...
- (void)setDragDelegate:(id<UITableViewDragLoadDelegate>)dragDelegateCC refreshDatePermanentKey:(NSString *)refreshDatePermanentKey;
